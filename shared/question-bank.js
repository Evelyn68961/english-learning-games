...
//   - grammar: [{ difficulty: 1|2|3, sentence, answer, options, hint }]
// Games pick whichever fields they need (whack-a-mole only uses words; the
// defense game uses words + grammar; future games can layer on more).
//
